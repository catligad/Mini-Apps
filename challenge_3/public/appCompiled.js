  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      if (this.state.checkoutPage) {
        ...
        pageRendered = React.createElement(FirstPage, null);
      } else if (this.state.secondPage) {
        pageRendered = React.createElement(SecondPage, null);
      } else if (this.state.thirdPage) {
        pageRendered = React.createElement(Thirdpage, null);
      }
...
function CheckoutPage(props) {
  ...
  return React.createElement(
    'div',
    { className: 'checkout', onClick: clickHandler.bind(this) },
    'Checkout'
  );
};
